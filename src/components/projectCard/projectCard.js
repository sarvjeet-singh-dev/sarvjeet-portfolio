export const projectCard = (project) => {
  ...
  return `
    <div data-id="${project.id}" class="project-cards rounded-2xl border border-zinc-800  bg-zinc-900/40 backdrop-blur-md p-5 cursor-pointer md:hover:scale-105 hover:border-green-500/40 transition-all duration-300 ">
      ...
      <button class="text-sm mt-4 px-3 py-2 rounded-full cursor-pointer active:scale-95 bg-green-500/40 hover:bg-green-800 transition-all duration-300"><a href="${project.liveDemo}" target="_blank" class="text-white">Live Demo</a></button>
      <button class="text-sm mt-4 px-3 py-2 rounded-full cursor-pointer active:scale-95 bg-green-500/40 hover:bg-green-800 transition-all duration-300"><a href="${project.githubRepo}" target="_blank" class="text-white">GitHub</a></button>
    </div>
  `
};